    ...
    <div>
        <section class="blogbanner center">
            <div class="blogbanner__heading">
                <h1 class="blogbanner__title">Articles & News</h1>
                <div class="blogbanner__breadcrumbs">
                    <router-link to="/" class="blogbanner__breadcrumbs__link">Home</router-link>
                    <router-link to="/blog" class="blogbanner__breadcrumbs__link">Blog</router-link>
                </div>
            </div>
        </section>
    </div>
...
.blogbanner {
    ...
    &__breadcrumbs__link::after {
        margin-left: 8px;
        margin-right: 5px;
        content: '/';
    }

    &__breadcrumbs__link:last-child::after {
        content: none;
    }
}
</style>